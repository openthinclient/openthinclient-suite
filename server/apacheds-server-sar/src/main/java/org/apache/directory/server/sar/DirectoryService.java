...
//			MBeanRegistration 
	...
	private String securityCredentials = null; //System.getProperty("ContextSecurityCredentials", "secret");
	...
	private String customSchema = null;
...
//			cfg.setBootstrapSchemas(addCustomBootstrapSchema(cfg.getBootstrapSchemas()));
			...
			Set<Object> classes = cfg.getBootstrapSchemas();
			classes.add(Class.forName(getEmbeddedCustomBootstrapSchema()).newInstance());
			cfg.setBootstrapSchemas(classes);
...
//	}
	...
	private Set<MutablePartitionConfiguration> addCustomPartition() throws NamingException {
		BasicAttributes attrs;
		Set<String> indexedAttrs;
		BasicAttribute attr;
	 ...
	 */
	public String getEmbeddedLDAPPort() {
		return String.valueOf(this.ldapPort);
	}
	 ...
	 * ()
	 */
	public String getEmbeddedLDAPSPort() {
		return String.valueOf(this.ldapsPort);
	}
	 ...
	 * ()
	 */
	public String getEmbeddedAnonymousAccess() {
		return Boolean.toString(this.anonymousAccess);
	}
	 ...
	 */
	public String getEmbeddedLDAPNetworkingSupport() {
		return Boolean.toString(this.ldapNetworkingSupport);
	}
	 ...
	 * ()
	 */
	public String getEmbeddedServerEnabled() {
		return Boolean.toString(this.embeddedServerEnabled);
	}
	 ...
	 */
	public void setEmbeddedAnonymousAccess(String anonymousAccess) {
		this.anonymousAccess = Boolean.parseBoolean(anonymousAccess);
	}
	 ...
	 */
	public void setEmbeddedLDAPNetworkingSupport(String ldapNetworkingSupport) {
		this.ldapNetworkingSupport = Boolean.parseBoolean(ldapNetworkingSupport);
	}
	 ...
	 * (int)
	 */
	public void setEmbeddedLDAPPort(String ldapPort) {
		if (ldapPort != null){
	 ...
	 * (int)
	 */
	public void setEmbeddedLDAPSPort(String ldapsPort) {
		if (ldapsPort != null) {
			this.ldapsPort = Integer.parseInt(ldapsPort);
		}
	}
	 ...
	 * (boolean)
	 */
	public void setEmbeddedServerEnabled(String enabled) {
		this.embeddedServerEnabled = Boolean.parseBoolean(enabled);
	}
	 ...
	 */
	public String getEmbeddedCustomBootstrapSchema() {
	 ...
	 */
	public void setEmbeddedCustomBootstrapSchema(String nisSchema) {
		this.customSchema = nisSchema;
	}
	 ...
	 */
	public String getEmbeddedAccessControlEnabled() {
		return Boolean.toString(this.accessControlEnabled);
	}
	 ...
	 */
	public String getEmbeddedEnableChangePassword() {
		return Boolean.toString(this.enableChangePassword);
	}
	 ...
	 * ()
	 */
	public String getEmbeddedEnableKerberos() {
		return Boolean.toString(this.enableKerberos);
	}
	 ...
	 */
	public String getEmbeddedEnableNtp() {
		return Boolean.toString(this.enableNtp);
	}
	 ...
	 */
	public void setEmbeddedAccessControlEnabled(String enabled) {
		this.accessControlEnabled = Boolean.parseBoolean(enabled);
	}
	 ...
	 */
	public void setEmbeddedEnableChangePassword(String enabled) {
		this.enableChangePassword = Boolean.parseBoolean(enabled);
	}
	 ...
	 * (boolean)
	 */
	public void setEmbeddedEnableKerberos(String enabled) {
		this.enableKerberos = Boolean.parseBoolean(enabled);
	}
	 ...
	 * (boolean)
	 */
	public void setEmbeddedEnableNtp(String enabled) {
		this.enableNtp = Boolean.parseBoolean(enabled);
	}
